...
def main(user, pw, inst, comm, cfg, title, imgs, nsfw, moduser, modpw):
    ...
    bestof.run(user, pw, inst, comm, cfg, title, io, nsfw, moduser, modpw)
    return "bestofbot"

# Start script
if __name__ == "__main__":
    try:
        main(BOTUSER, BOTPW, BOTINSTANCE, POSTCOMMUNITY, COMMUNITIES, TITLE, int(IMAGESONLY), int(NSFW), MODUSER, MODPW)
